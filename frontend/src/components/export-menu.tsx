  ...
  return (
    <div ref={menuRef} className="relative w-full sm:w-auto print:hidden">
      <button
        ...
        className="w-full whitespace-nowrap rounded-lg border border-zinc-300 px-3 py-1.5 text-sm transition-colors hover:bg-zinc-100 sm:w-auto dark:border-zinc-700 dark:hover:bg-zinc-800"
      >
        내보내기
      </button>
